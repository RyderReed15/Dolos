...
namespace valve {
    ...
    class texinfo_t
    {
        using type_vecs = std::array<rn::vector4, 2>;
    ...
    public:
        rn::vector3 origin = 0.f;
        float   distance = 0.f;
    };

    class polygon
    {
        using type_surfinfo_vecs = std::array<rn::vector3, MAX_SURFINFO_VERTS>;
